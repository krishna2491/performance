...
var ContentFlowGlobal = {
    ...
    //init: function () {
        ...
        //this.addStylesheet(this.CSSBaseDir+'mycontentflow.css'); dee   // FF2: without adding a css-file FF2 hangs on a reload.
                                                                    //      I don't have the slidest idea why
                                                                    //      Could be timing problem
        //this.loadAddOns = new Array();
        /* add AddOns scripts  dee: can be removed i guess */
        ...
        // Dee no need for autolaod in angular
        ...
        // Dee no need for IE support in angular
   ...
   // onloadInit: function () {
        ...
        /* init the rest dee: ai=utoinit not needed*/
...
ContentFlowItem.prototype = {
    ...
    makeActive: function () {
        ...
        this.toggleTab(this.element);
    },
    // TODO: its a temp hack
    toggleTab : function (element) {
            
            var list = $(element);
            var tabPanes = $(list.parents(".ContentFlow").data('tab-pane'));
            var pane = tabPanes.find('.' + list.data('tab-ref'));
            //container.
    ...
    addReflection: function() {
        ...
        if (this.Browser.IE) {
            ...
            if (canvas.getContext) {
                ...
                if (CFobj._reflectionWithinImage) {
                    image.parentNode && image.parentNode.replaceChild(canvas, image);
                    this.content = canvas;
...
/* ==================== start it all up ==================== */
// dee: init callmoved into angular controller, TODOmove to directive
