...
public class EmFeedbackRequesterMasterDto implements Serializable {
    ...
    public EmFeedbackRequesterMasterDto() {
    }

    public EmFeedbackRequesterMasterDto(Integer feedbackRequesterId) {
        this.feedbackRequesterId = feedbackRequesterId;
    }

    public EmFeedbackRequesterMasterDto(Integer feedbackRequesterId, int employeeId, int feedbackForEmpId, int projectId, int departmentId, String feedbackTitle) {
        this.feedbackRequesterId = feedbackRequesterId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmFeedbackRequesterMasterDto)) {
            return false;
        }
        EmFeedbackRequesterMasterDto other = (EmFeedbackRequesterMasterDto) object;
