 ...
 */
@Entity
@Table(name = "em_feedback_request_mpg")

@XmlRootElement
public class FeedbackRequestParaMpg implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Basic(optional = false)
    @Column(name = "feedback_request_mpg_id")
