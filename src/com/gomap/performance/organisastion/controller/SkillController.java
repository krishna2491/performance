...
public class SkillController {
	...
	@CrossOrigin(origins = AppConstants.CORS)
	@RequestMapping(value = {UrlConstants.API_DELETE_SKILL}, method = RequestMethod.POST)
	public @ResponseBody ResponseDTO deleteSkill(@RequestBody EmSkillDto emSkillDto, BindingResult result) {
		ResponseDTO  responseDTO = null;
		try {  
			if(result.hasErrors()){
				responseDTO = new ResponseDTO();
